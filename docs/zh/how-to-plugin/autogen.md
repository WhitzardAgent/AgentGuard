...
## 导入方法
使用 `Guard.attach_autogen()` 这个 Adapter 方法可以自动将 AutoGen 智能体实例与 AgentGuard 关联起来，你不再需要对 AutoGen SDK 原本的代码做任何修改。

我们的 AutoGen Adapter 关联的智能体实例是 `AssistantAgent` 对象。
