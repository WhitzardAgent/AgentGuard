...
const elements = {
  ...
  rulePhaseButton: getElement("rule-phase-button"),
  rulePhaseSummary: getElement("rule-phase-summary"),
  rulePhaseMenu: getElement("rule-phase-menu"),
  rulePhaseInputs: queryElements("input[name='rule-phase']"),
  ruleOnButton: getElement("rule-on-button"),
  ruleOnSummary: getElement("rule-on-summary"),
  ruleOnMenu: getElement("rule-on-menu"),
