(function () {
  ...
  const EXACT_TRANSLATIONS = {
    zh: {
      ...
      "Create Account - AgentGuard": "注册 - AgentGuard",
      "Control Plane": "控制台",
      "Sign in to AgentGuard": "登录 AgentGuard",
      "Create your AgentGuard account": "创建你的 AgentGuard 账号",
      "Use your AgentGuard account to enter the console.": "使用你的 AgentGuard 账号进入控制台。",
      "Use email verification to register a new account.": "使用邮箱验证码注册一个新账号。",
      Username: "用户名",
      Password: "密码",
      "Sign In": "登录",
      "New Username": "新用户名",
      ...
      "Code sent.": "验证码已发送。",
      "Code sent. Try again in {seconds} seconds.": "验证码已发送。请在 {seconds} 秒后重试。",
      "Failed to send code.": "发送验证码失败。",
      "Account created. Sign in with it.": "账号已创建，请使用该账号登录。",
      ...
      "Delete this item?": "确定删除这个项目吗？",
      "Delete this group?": "确定删除这个分组吗？",
      "Delete this organization and all of its groups?": "确定删除这个组织及其所有分组吗？",
      "Deleting...": "删除中…",
      "Only LangChain and Dify agent records can be deleted from this page.": "此页面仅支持删除 LangChain 和 Dify 智能体记录。",
      "Delete the local record for {agent}? This removes the agent, its sessions, and local history from AgentGuard.": "确定删除 {agent} 的本地记录吗？这会从 AgentGuard 中移除该智能体、其会话和本地历史。",
      "Deleting local record for {agent}...": "正在删除 {agent} 的本地记录…",
      "Deleted local record for {agent}.": "已删除 {agent} 的本地记录。",
      "Delete failed. Local agent records were not changed.": "删除失败，本地智能体记录未发生变更。",
      ...
      "Tool Trace": "工具调用链",
      "I want to monitor an execution chain. In trace mode, any tool / runtime phase filter refers to the last tool on the tool trace.": "我想监控一条执行链。在该模式下，任何工具/运行阶段筛选都指向该工具轨迹中的最后一个工具。",
      "Select Runtime Phases and Target Tool": "选择运行阶段与目标工具",
      "When you use": "当你使用",
      ", the": "时，这里的",
      "here apply to the": "会作用于该轨迹中的",
      "on that trace.": "。",
      "Runtime Phases": "运行阶段",
      "Choose which runtime stages this rule should evaluate against.": "选择这条规则应该在哪些运行阶段生效。",
      "Optionally narrow tool-phase rules to one specific tool.": "可选地将工具阶段规则收窄到某个具体工具。",
      ...
      "Build Tool TRACE by adding one or more concrete or wildcard segments. Any selected tool or runtime phase filter refers to the final tool on the trace.": "通过添加一个或多个具体段或通配段来构建 Tool TRACE。任何已选工具或运行阶段筛选都指向该轨迹中的最后一个工具。",
      "PATH:": "PATH：",
      ...
      "Rules Trace On Hint": "当你使用 <strong>Tool Trace</strong> 时，这里的 <strong>Tool</strong> 和所选的 <strong>Runtime Phases</strong> 会作用于该轨迹中的<strong>最后一个工具</strong>。",
      "User Studio": "用户工作台",
      "User Centre": "用户中心",
      ...
      Provider: "提供方",
      Name: "名称",
      "LangChain Ticket": "LangChain 凭证",
      Ticket: "凭证",
      "Copy Ticket": "复制凭证",
      "Signed in as {username} (user #{id}). {email_status}": "当前登录：{username}（用户 #{id}）。{email_status}",
      "Email: {email}.": "邮箱：{email}。",
      "Email: {email} (unverified).": "邮箱：{email}（未验证）。",
      "Email: not bound.": "邮箱：未绑定。",
      "Not signed in.": "未登录。",
      External: "外部",
      "Expires in {seconds} seconds.": "{seconds} 秒后过期。",
      "This ticket is short-lived.": "该凭证有效期较短。",
      "Failed to generate ticket.": "生成凭证失败。",
      "Ticket copied.": "凭证已复制。",
      "Failed to copy ticket.": "复制凭证失败。",
      "Signed out.": "已退出登录。",
      "New passwords do not match.": "两次输入的新密码不一致。",
      "Password updated.": "密码已更新。",
      "Failed to update password.": "修改密码失败。",
      "{label} account bound.": "{label} 账号已绑定。",
      "Failed to bind {label} account.": "绑定 {label} 账号失败。",
      Unbind: "解绑",
      "OpenClaw binding unbound.": "OpenClaw 绑定已解绑。",
      "External account unbound.": "外部账号已解绑。",
      "Failed to unbind OpenClaw binding.": "解绑 OpenClaw 绑定失败。",
      "Failed to unbind external account.": "解绑外部账号失败。",
      ...
      "Agent Security Audit - AgentGuard": "智能体安全审计 - AgentGuard",
      "Security Audit": "安全审计",
      "Agent Security Audit": "智能体安全审计",
      "Audit all activity for": "审计智能体的全部活动：",
      "Review every user's sessions and traces with deterministic rules and evidence-backed LLM analysis.": "使用确定性规则和有证据支撑的大模型分析，审查每位用户的 Session 与 Trace。",
      "Security audit summary": "安全审计概览",
      "Latest status": "最新状态",
      "Latest risk": "最新风险",
      "Trace events": "Trace 事件",
      "Review all users, sessions, and traces for the selected agent.": "审查所选智能体的所有用户、Session 与 Trace。",
      "Start a new audit": "开始新的审计",
      "Rule audits finish quickly. LLM and hybrid audits may take several minutes.": "规则审计通常很快；大模型和混合审计可能需要数分钟。",
      "LLM Settings": "大模型设置",
      "Security audit LLM settings": "安全审计大模型设置",
      "Saved only in this browser and sent only when starting an LLM or hybrid audit. Leave fields blank to use server defaults.": "配置仅保存在当前浏览器中，并且只在启动大模型或混合审计时发送。留空则使用服务端默认配置。",
      "Close LLM settings": "关闭大模型设置",
      "Base URL": "接口地址",
      "API Key": "API 密钥",
      "Timeout (seconds)": "超时时间（秒）",
      "Events per LLM chunk": "每个大模型分块的事件数",
      Cancel: "取消",
      "Save settings": "保存设置",
      "Browser override configured": "已配置浏览器参数",
      "Using server defaults": "正在使用服务端默认配置",
      "LLM settings saved in this browser.": "大模型设置已保存在当前浏览器中。",
      "Refresh audit runs": "刷新审计任务",
      "Audit mode": "审计模式",
      "Start time (optional)": "开始时间（可选）",
      "End time (optional)": "结束时间（可选）",
      "Start time, Beijing (optional)": "开始时间，北京时间（可选）",
      "End time, Beijing (optional)": "结束时间，北京时间（可选）",
      "Start Audit": "开始审计",
      "Audit history": "审计历史",
      "Select a run to inspect its report and trace evidence.": "选择一条任务以查看报告和 Trace 证据。",
      Created: "创建时间",
      "Created (Beijing time)": "创建时间（北京时间）",
      Mode: "模式",
      "Status / Stage": "状态 / 阶段",
      Risk: "风险",
      Coverage: "覆盖范围",
      ...
      "Select an audit run.": "请选择一条审计任务。",
      "Rules only": "仅规则",
      "LLM only": "仅大模型",
      "Rules + LLM": "规则 + 大模型",
      "Deterministic cross-session and cross-user security checks.": "确定性的跨 Session、跨用户安全检查。",
      "LLM-assisted semantic and cross-session security analysis.": "由大模型辅助的语义和跨 Session 安全分析。",
      "Deterministic rules plus evidence-validated LLM analysis.": "确定性规则与证据校验后的大模型分析。",
      Queued: "排队中",
      Running: "运行中",
      Completed: "已完成",
      Failed: "失败",
      "Waiting to start": "等待开始",
      "Collecting traces": "正在收集 Trace",
      "Preparing sessions": "正在整理 Session",
      "Running deterministic rules": "正在运行确定性规则",
      "Running LLM analysis": "正在运行大模型分析",
      "Saving report": "正在保存报告",
      "Interrupted by server restart": "因服务重启而中断",
      "Report ready": "报告已就绪",
      "Audit failed": "审计失败",
      Critical: "严重",
      High: "高",
      ...
      "{users} users · {sessions} sessions": "{users} 位用户 · {sessions} 个 Session",
      "{events} trace events": "{events} 条 Trace 事件",
      "{users} users · {sessions} sessions · {events} events": "{users} 位用户 · {sessions} 个 Session · {events} 条事件",
      "No security audit runs yet.": "该智能体还没有安全审计记录。",
      Status: "状态",
      Stage: "阶段",
      Model: "模型",
      "Not configured": "未配置",
      "The model is reviewing session evidence and the final aggregate report. This can take several minutes.": "模型正在审查 Session 证据并生成最终汇总报告，可能需要数分钟。",
      Error: "错误",
      Limitation: "限制",
      "No findings recorded.": "没有记录到安全发现。",
      "Input scope: complete stable snapshot for this agent": "输入范围：该智能体的完整稳定快照",
      Confirmed: "已证实",
      "Needs review": "待人工确认",
      Session: "会话",
      Events: "事件",
      "No evidence detail": "没有证据详情",
      Recommendation: "处置建议",
      "Audit {run_id} queued.": "审计任务 {run_id} 已进入队列。",
      rule: "规则",
      llm_session: "Session 大模型",
      llm_aggregate: "汇总大模型",
      alignment_failure: "对齐失败",
      policy_evasion: "策略规避",
      enforcement_bypass: "执行绕过",
      audit_gap: "审计缺口",
      risk_concentration: "风险集中",
      identity_boundary: "身份边界",
      data_exfiltration: "数据外传",
      policy_enforcement_failure: "策略执行失败",
      unsafe_tool_use: "不安全工具调用",
      thought_alignment_violation: "思维对齐违规",
      enforcement_gap: "执行缺口",
      systemic_enforcement_gap: "系统性执行缺口",
      plugin_misconfiguration: "插件配置错误",
      policy_absence: "策略缺失",
      sensitive_file_access: "敏感文件访问",
      credential_exposure: "凭据暴露",
      sensitive_data_exposure: "敏感数据暴露",
      unauthorized_tool_use: "未授权工具调用",
      security_control_failure: "安全控制失败",
      policy_bypass: "策略绕过",
      "Thought alignment failed open": "思维对齐失败后放行",
      "Thought-Aligner failed and the original model output was allowed to continue.": "Thought-Aligner 执行失败，但原始模型输出仍被允许继续执行。",
      "Thought-Aligner was unavailable and the configured failure mode allowed the original model output to continue. This is degraded control coverage, not by itself proof of a successful attack.": "Thought-Aligner 不可用，且当前失败处理模式允许原始模型输出继续执行。这表示安全控制覆盖降级，但本身不能证明攻击已经成功。",
      "Use failure_mode=deny for sensitive agents and investigate the alignment endpoint failure.": "对敏感智能体使用 failure_mode=deny，并排查对齐服务端点故障。",
      "A tool accessed a potentially sensitive file": "工具访问了可能敏感的文件",
      "Confirm that the user and agent were authorized to read the files, then restrict file tools with path allowlists and least privilege.": "确认用户和智能体是否有权读取这些文件，并通过路径允许列表和最小权限限制文件工具。",
      "Sensitive data was passed to an outbound tool": "敏感数据被传递给外发工具",
      "Content obtained from a sensitive file or containing credential-like material was subsequently included in an outbound tool invocation.": "从敏感文件获得的内容或类似凭据的数据，随后被包含在外发工具调用中。",
      "Revoke exposed credentials if applicable, block the destination, and enforce data-flow controls between file/secret tools and outbound tools.": "如适用，请撤销已暴露凭据、阻止相关目标，并在文件/密钥工具与外发工具之间实施数据流控制。",
      Skills: "技能",
