...
AgentGuard 可以集成到现有的智能体框架中，无需修改底层的执行逻辑。目前，它支持 LangChain、AutoGen、OpenAI Agents SDK 和 [OpenClaw](https://github.com/openclaw/openclaw) 的集成，并且我们正在持续扩大对更多智能体生态系统和框架的支持。关于 OpenClaw 的 JavaScript 侧接入方式，可参见文档中的 `OpenClaw` 章节。
...
> AgentGuard 也提供了可视化策略配置方式，并支持策略的动态热更新，详情请参考 [这里](https://whitzard.tech/AgentGuard/zh/policies/quick_config.html)。
